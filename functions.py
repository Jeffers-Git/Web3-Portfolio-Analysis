...
def calculate_metrics(phantom_data, phantom2_data, solfl_data, solfl2_data,
                      ...
                      monadnfts_data, backpackmon_data, monadsnipe_data, monadiphone_data, monadmevx_data):
    """
    ...
    df_list = [phantom_data, phantom2_data, solfl_data, solfl2_data,
              ...
              backpacklaptop3_data, backpacklaptop4_data, backpackphone1_data, backpackphone2_data,
              slushphone1_data, slushphone2_data, slushphone3_data, slushphone4_data,
               bitget_data, bybit_data, photon_data, ledgernew_data, monadmain_data, monadnfts_data, backpackmon_data,
               monadsnipe_data, monadiphone_data, monadmevx_data]
    ...
    keys = ['Metric', 'Phantom', 'Phantom 2', 'Solflare', 'Solflare 2',
            ...
            'Ledger new', 'Monad main', 'Monad NFTs' 'Backpack monad', 'Monad snipe', 'Monad iphone', 'Monad mevx']
    ...
    port_values = ['Portfolio value', phantom_data['total value'].sum(), phantom2_data['total value'].sum(), solfl_data['total value'].sum(), solfl2_data['total value'].sum(),
                   ...
                   monadmain_data['total value'].sum(), monadnfts_data['total value'].sum(), backpackmon_data['total value'].sum(), monadsnipe_data['total value'].sum(),
                   monadiphone_data['total value'].sum(), monadmevx_data['total value'].sum()]
